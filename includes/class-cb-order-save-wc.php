...
class Cb_Order_Save_Wc {
	 ...
	 */
	 ...
	 public function __construct() {
		...
		$this->plugin_name = 'cb-order-save-wc';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-cb-order-save-wc-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-cb-order-save-wc-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-cb-order-save-wc-admin.php';
	 ...
	 *
	 * Uses the Cb_Order_Save_Wc_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Cb_Order_Save_Wc_Loader    Orchestrates the hooks of the plugin.
	 */
